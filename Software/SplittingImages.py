...
data_path = "D:\\Datasets\\arti_sim\\log_seven"


train_dest = "D:\\Datasets\\arti_sim\\seven_class\\training"  # Destination to train set(folder)
val_dest = "D:\\Datasets\\arti_sim\\seven_class\\validation"  # Destination to validation set(folder)
test_dest = "D:\\Datasets\\arti_sim\\seven_class\\test"       # Destination to test set(folder)

classes = ("Hard_Left", "Hard_Right", "Left", "Right", "Soft_Left", "Soft_Right", "Straight")  # Classes
